...
def generate():
    ...
    generate_content_config = types.GenerateContentConfig(
        ...
        system_instruction="Convert the input image to a realistic watercolor painting."
    )
